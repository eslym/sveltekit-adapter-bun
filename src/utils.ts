/**
 * Source: https://github.com/sveltejs/kit/packages/kit/src/utils/import.js
 * Used to ensure same vite are used as sveltekit
 */
 ...
 */
function resolve_peer(dependency: string) {
 ...
 * @param {string} dependency
 */
export async function import_peer<T>(dependency: string): Promise<T> {
	try {
